...
class Cinematique1 extends Phaser.Scene {
    ...
    update(time, delta) {
        ...
        if (this.eddison.x <= 480 && this.walkE) {
            ...
            var content = [
                "Salutation, je suis Chênebleu, directeur générale de L'Organisation des Nations unies pour l’alimentation et l’agriculture",
                "(ONUAA), et je suis à la recherche d\'un agriculteur prêt à relever le défi !",
                "",
                "Mosbert :",
                "Bonjour Chênebleu, vous l’avez sous vos yeux. Je suis Mosbert, le meilleur des agriculteurs, pourquoi me cherchez-vous ?",
                "",
                "Chênebleu :",
    ...
    update(time, delta) {
        ...
        if (this.Mathieu.x <= 300 && !this.nextS && this.walk) {
            ...
            var content = [
                ...
                "",
                "Mosbert :",
                "Enchanté de faire ta connaissance Seedy, moi c’est Mosbert, Chênebleu m'a parler de toi",
                "",
                "Seedy :",
