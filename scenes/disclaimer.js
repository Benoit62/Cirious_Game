class Disclaimer extends Phaser.Scene {
    ...
    create() {
        ...
        const txt = this.make.text({
            x: 0,
            y: 0,
            text: 'Un simple avertissement pour vous dire que ce n\'est pas un jeu avec des tracteurs qui volent. Quand nous parlons de ferme du futur, c’est pour une échéance de 5 à 10 ans, avec les objectifs cités précédemment. \n\nConcernant le bien-être animal, certains peuvent être choqués, cependant nous sommes factuels. Le débat n\'est pas de dire si tout le monde doit devenir végétarien mais bien de protéger aux mieux les animaux dans l\'état actuel des choses. \n\nDe nombreux autres points ne sont pas abordés, (gestion des sols, culture hors-sol, productions animales dérivées) mais nous ne prétendons pas faire une liste exhaustive de tout ce qu’il faut améliorer dans le futur. Nous présentons simplement certaines choses que nous pouvons améliorer, des solutions qui parfois existent déjà mais qui doivent être plus répandues, et surtout nous ouvrons la porte à votre réflexion et à votre curiosité pour creuser le sujet. \n\n\nMais après tout ce n’est qu’un jeu donc Have Fun ! ',
            style:{
                fontSize:20,
                fontFamily:'MC',
                align:'center',
