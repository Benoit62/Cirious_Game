let data = [
    ...
    //Structures
    {
        ...
        desc: 'Le tank permet de récupérer et stocker de l\'eau qui pourra être utilisée pour les cultures',
        info: '',
    ...
    },
    {
        ...
        info: 'Moyennement efficace et demande du temps, cependant attention à la biodiversité si ce n\'est pas suffisament controlé',
        unlock: false,
        unlockPrice:9000,
        health: 2,
        ecology: 2,
    ...
    },
    {
        ...
        typeName: 'Nourriture pour animaux',
        name: 'Fourrages',
        desc: 'Plante ou mélange de plantes, utilisées pour l\'alimentation des animaux d\'élevage.',
